...
The results of the cumulative link mixed models for the ordinal dependent variables of justice in differential access to health, pensions and education by income are presented in @tbl-ordinal-reg[^1]. 
