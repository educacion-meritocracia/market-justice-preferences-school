...
data_rec %>% 
  ...
  sjPlot::plot_stackfrq(expand.grid =TRUE,
                      geom.colors = c("#7d7d7d","#ababab","#cecece","#ebebeb"),
                      show.total = FALSE, 
...
The results of the cumulative link mixed models for the ordinal dependent variables of justice in differential access to health, pensions and education by income are presented in @tbl-ordinal-reg. This table shows the effects of individual and contextual-level independent variables related to our hypothesis; however, the models also incorporate the control variables utilized in the study for each of the three dependent variables separately (complete models are available in the [Appendix](#appendix)).
...
#| tbl-cap: "Cumulative link multilevel models of differential acces justificacion of education, health and pensions"
...
texreg::htmlreg(l = list(modelos_odd_health[[2]],
                         modelos_odd_health[[3]],
                         modelos_odd_pension[[2]],
                         modelos_odd_pension[[3]],
                         modelos_odd_educ[[2]],
                         modelos_odd_educ[[3]]),   
                caption = NULL,
                stars = c(0.05, 0.01, 0.001),
                custom.note = "Note: Coefficients models in odds-ratio. Control variables are included. Standard errors in parentheses. %stars",
