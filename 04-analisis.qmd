...
The results of the cumulative link mixed models for the ordinal dependent variables of justice in differential access to education, health, and pensions by income are presented in @tbl-ordinal-reg. This table shows the effects of individual and contextual-level independent variables related to our hypothesis; however, the models also incorporate the control variables utilized in the study for each of the three dependent variables separately (complete models are available in the [Appendix](#appendix)).
...
texreg::htmlreg(l = list(modelos_odd_educ[[2]],
                         modelos_odd_educ[[3]],
                         modelos_odd_health[[2]],
