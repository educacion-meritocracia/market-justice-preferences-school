...
# Translated items for market justice preferences

```{r echo=FALSE}
#| tbl-cap: "Translation of items for health, pensions, and education"
#| label: tbl-translation

data <- data.frame(
  English = c("It is just that in Chile people with higher incomes can access better health services than people with low incomes",
              "It is just that in Chile people with higher incomes can have better pensions than people with low incomes",
              "It is just that in Chile people who can pay have a better education for their children"),
  Spanish = c("Es justo que en Chile las personas con mayores ingresos puedan acceder a una mejor atención de salud que las personas con ingresos más bajos",
...
kableExtra::kable(data, 
      col.names = c("English Translation", "Original Spanish"), 
